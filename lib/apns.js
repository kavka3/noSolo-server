...
function checkMessageType(notification){
    ...
    switch(notification.notificationType){
        ...
        case USER_JOINS_ACTIVITY: message = notification.specialData.surname + ' joined activity';break;
...
function sendNtfToApple(udId, ntf){
    ...
    note.payload = {'messageFrom': 'noSolo', ntfId: ntf._id, ntfType: 'ntf'};
    note.device = device;
    var apnsConnection = new apn.Connection(options);
    apnsConnection.pushNotification(note, device);
...
function sendNtfToAndroid(udIds, ntf){
    console.log('SEND PUSH TO ANDROID');
